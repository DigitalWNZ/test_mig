# The name of this view in Looker is "Events 20220624"
view: events {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `agolis-allen-first.bingoblast.events_*`
    ;;
  ...
  parameter: and_or {
    type: unquoted
    allowed_value: {value:"and"}
    allowed_value: {value:"or"}
  }
  parameter: g1_category {
    type: string
    suggest_explore: key_value
    suggest_dimension: key_value.cat
  }

  parameter: g1_key {
    type: string
    suggest_explore: key_value
    suggest_dimension: key_value.key
  }

  parameter: g1_value {
    type: string
    suggest_explore: key_value
    suggest_dimension: key_value.value
  }

  parameter: g2_category {
    type: string
    suggest_explore: key_value
    suggest_dimension: key_value.cat
  }
...
# The name of this view in Looker is "Events 20220624 Event Params"
...
# The name of this view in Looker is "Events 20220624 User Properties"
